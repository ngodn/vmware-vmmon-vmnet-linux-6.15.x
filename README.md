# VMware Workstation 17.6.4 - Linux Kernel 6.15.x Compatibility Fixes

![VMware](https://img.shields.io/badge/VMware-Workstation_17.6.4-blue)
![Kernel](https://img.shields.io/badge/Linux_Kernel-6.15.x-green)
![Status](https://img.shields.io/badge/Status-✅_WORKING-success)

This repository contains **fully patched and working** VMware host modules with all necessary fixes applied to make VMware Workstation 17.6.4 compatible with Linux kernel 6.15.x and potentially newer kernels.
...
```bash
# Clone this repository with all kernel 6.15.x fixes already applied
...
### **All Kernel 6.15.x Fixes Applied**
...
This repository contains fully working patches for kernel 6.15.x. If you encounter issues with newer kernels or have improvements:
...
- **Kernel**: 6.15.x-x64v3-t2-noble-xanmod1  
